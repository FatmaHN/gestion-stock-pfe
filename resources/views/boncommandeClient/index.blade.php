            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="text-center card-body">
                        <a href="{{route('createbonclient')}}" class="text-center fs-5 btn btn-warning btn-sm" title="Ajouter une commande">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-striped">
                                ...
                                <tbody class="table-striped">
                                    @foreach ($bon_commande_client as $item)
                                    <tr>
                                        <td>{{$item->desc}}</td>
                                        <td>{{$item->dat_com}}</td>
                                        <td>{{$item->dat_exp}}</td>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="m-1 col">
                                                        <a href="{{ url('/boncommandeclient/' . $item->id) }}">
                                                ...
                                                <div class="m-1 col">
                                                        <a href="{{ url('/lignecommandeclient/' . $item->id) }}">
                                            ...
                                            <div class="row">
                                                <div class="m-1 col">
                                                       <a href="{{ url('/boncommandeclient/' . $item->id . '/edit') }}">
                                                ...
                                                <div class="m-1 col">
                                                    <form method="POST" action="{{ url('/boncommandeclient' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                        {{ method_field('DELETE') }}
                                                        {{ csrf_field() }}
